...
<article id="post-<?php the_ID(); ?>" <?php post_class( "cb-blog-style-e cb-article-small cb-article cb-article-row-2 cb-article-row cb-separated clearfix cb-no-$cb_count" ); ?>>
